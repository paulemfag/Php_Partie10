...
include 'header.php';
    ...
    $streetnmbr = $_POST['streetnmbr'];
    $streetextension = $_POST['streetextension'];
    $street = $_POST['street'];
    $city = $_POST['city'];
    ...
    <p><?= 'Votre lien codecademy est <a title="codecademy" href="'.$codecademy.'">ici.</a>' ?></p>
        <?php } ?>
    <p><?= 'A la question " Si vous étiez un super héros/une super héroïne, qui seriez-vous et pourquoi ? " vous avez répondu(e) : <br><br>' . $superhero ?></p>
    <p><?= 'A la question " Racontez-nous un de vos "hacks" (pas forcément technique ou informatique) " vous avez répondu(e) : <br><br>' . $hack ?></p>
    <p><?= 'A la question " Avez vous déjà eu une expérience avec la programmation et/ou l\'informatique avant de remplir ce formulaire ? " vous avez répondu(e) : <br><br>' . $experience ?></p>
<?php }  else {
    ?>
    <div class="container col-4">
        <form method="POST" action="#">
            ...
            <div class='form-group'>
                <label for="codecademy">Lien codecademy ( facultatif ) : </label>
                <input  type="url" id="codecademy" name="codecademy" placeholder="www.codecademy.com">
            </div>
            <div class='form-group'>
